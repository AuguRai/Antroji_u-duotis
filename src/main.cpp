...
int main()
{
	...
	if (ats1 == "t")
	{
		...
		if (ats4 == "n")
		{
			cout << "Ar norite, kad list ir vector tipo konteineriai butu palyginti pagal grupavima? Jei ne - n, jei norite, jei taip - t ";
			cin >> ats5;
			...
			if (ats5 == "n")
			{
				...
				if (ats6 == "t")
				{
					...
					list <duomenys> vargsiukai, stud_sar_list;
